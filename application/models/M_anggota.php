...
class M_anggota extends CI_Model{
  ...
  function tampil_data(){
    $query=$this->db->query("SELECT * FROM v_user WHERE id_koperasi = '2' order by no_anggota ASC, nama ASC");
    return $query;
  }
  ...
  function cari_anggota($a){
    $query=$this->db->query("SELECT * FROM v_user WHERE id_koperasi = '2' AND no_anggota = '$a'")->result();
    return $query;
  }
