    ...
    <section class="content">    
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                <h2 class="box-title"><b><i class="fa fa-gear"></i> Tentang KPRI SEHAT DKK</b></h2>
            </div>
            <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" value="<?= $a->nama ?>" placeholder="KPRI SEHAT DKK" required>
                            </div>
                            <div class="form-group">
                                <label for="">Email</label>
                                <input type="email" name="email_support" class="form-control" value="<?= $a->email_support ?>" placeholder="Email" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="">WA Koperasi</label>
                                <input type="text" name="wa" class="form-control" value="<?= $a->wa ?>" placeholder="WA Koperasi" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="">Kontak Koperasi</label>
                                <input type="text" name="kontak" class="form-control" value="<?= $a->kontak ?>" placeholder="Kontak Koperasi" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Alamat Koperasi</label>
                                <input type="text" name="alamat" class="form-control" value="<?= $a->alamat ?>" placeholder="Alamat Koperasi" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
