            ...
            <div class="col-md-12">                
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form action="admin/anggota/aksi_edit" target="_blank" method="post">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>No. Anggota</label>
                                        <input type="text" name="no_anggota" class="form-control" placeholder="No. Anggota" value="<?= $a->no_anggota ?>" required>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="pekerjaan" class="form-control" placeholder="Pekerjaan" value="<?= $a->pekerjaan ?>" required>
                                    </div>
                                </div>  
                            </div>
                            <div class="row">          
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_hp" class="form-control" value="<?= $a->no_hp ?>" placeholder="No. HP" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="">RT</label>
                                        <input type="text" name="rt" placeholder="RT" value="<?= $a->rt ?>" class="form-control" required>
                                    </div>
                                </div>      
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="">RW</label>
                                        <input type="text" name="rw" placeholder="RW" value="<?= $a->rw ?>" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
