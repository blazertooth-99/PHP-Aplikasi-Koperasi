    ...
    <section class="content">    
        ...
        <div class="box box-default">
            ...
            <div class="box-header with-border">
                <h2 class="box-title"><b><i class="fa fa-edit"></i> Edit Banner</b></h2>
            </div>
            <div class="box-body">
                <?php foreach($edit as $a) : ?>
                <form action="admin/banner/aksi_edit" method="post" enctype="multipart/form-data">
                    <div class="row col-lg-6">
                     
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label for="">Foto Banner</label><br>
