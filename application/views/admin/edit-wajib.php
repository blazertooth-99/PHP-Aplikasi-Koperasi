            ...
            <div class="col-md-12">                
                <div class="box">
                    <div class="box-header with-border">
                        <h2 class="box-title"><b><i class="fa fa-edit"></i> Edit Simpanan Wajib</b></h2>
                    </div>
                    <?php foreach($edit as $a) : ?>
                    <form action="admin/simpanan/aksi_edit/wajib" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="text" name="periode" class="form-control" value="<?= $a->periode ?>" placeholder="Periode" required>
                            </div> -->
                            <div class="form-group">
