            ...
            <div class="col-md-12">                
                <div class="box">
                    <div class="box-header with-border">
                        <h2 class="box-title"><b><i class="fa fa-plus-square"></i> Tambah Simpanan Sukarela</b></h2>
                    </div>
                    <form action="admin/simpanan/aksi_tambah/sukarela" method="post" enctype="multipart/form-data">
                        <div class="box-body">
