        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="page-header">
                    <img src="img/logo.png" width="30"> KPRI SEHAT DKK
                    <small class="pull-right"> <?= tanggal_indo(date('Y-m-d')) ?></small>
                </h2>
                <center><h4><b>LAPORAN RIWAYAT TRANSAKSI SIMPANAN WAJIB ANGGOTA<br> PERIODE <?= tanggal_indo(date('Y-12-31')) ?></b></h4></center>
            </div>
        </div><br>
