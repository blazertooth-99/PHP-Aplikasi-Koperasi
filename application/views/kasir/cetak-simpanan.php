...
<body onload="window.print(); setTimeout(window.close, 0);">
    ...
    <center>
        <p>
            <strong>KPRI SEHAT DKK</strong> <br>
            <small>Jl. jendral sudirman Kav 4 Bangkle Blora<br>Email : adminsehatdkk@7indora.com Telp : 081809434513</small>
        </p>
        ===================================================================================
    ...
    <center>
        <p>
            <small>Terima kasih atas kepercayaan Anda kepada KPRI SEHAT DKK <br> www.7indora.com</small>
        </p>
    </center>
</body>
