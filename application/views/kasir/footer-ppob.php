            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2020 <a href="https://7indora.com/" target="_blank">INDORA</a>.</strong> All rights
                reserved.
		    </footer>
        </div>
      <!-- /.tab-pane -->
...
<div class="modal fade" id="modal-default">
  <div class="modal-dialog" style="width:60%; margin-top:15%;">
    <div class="modal-content">
      <form action="<?= base_url() ?>kasir/home/pembayaran" method="post">
...
<script src="<?= base_url() ?>template/jquery-ui.js"></script>
...
<script src="<?= base_url() ?>template/template.js"></script>
...
<script src="<?= base_url() ?>template/iCheck/icheck.min.js"></script>
...
<script src="<?= base_url() ?>template/bootstrap-slider/bootstrap-slider.js"></script>
<script src="<?= base_url() ?>template/java.js"></script>
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#no_anggota').autocomplete({
      source: "<?= base_url() ?>kasir/transaksi/cari_anggota",
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#barcode').autocomplete({
      source: "<?= base_url() ?>kasir/home/cari_produk",
      select: function (event, ui) {
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#nama_produk').autocomplete({
      source: "<?= base_url() ?>kasir/home/cari_produk2",
      select: function (event, ui) {
        $('[name="id_produk"]').val(ui.item.id_produk);
...
<script type="text/javascript">
  $(document).ready(function(){
    $('#provider').autocomplete({
      source: "<?= base_url() ?>kasir/ppob/cari_provider",
      select: function (event, ui) {
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"<?php echo base_url('kasir/ajaxsearch/fetch'); ?>",
			method:"POST",
			data:{query:query},
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"<?php echo base_url('kasir/ajaxsearch/data'); ?>",
			method:"POST",
			data:{query:query},
			success:function(data){
				$('#result').html(data);
	...
	$('#cari_paket_data').keyup(function(){
		var search = $(this).val();
		if(search != '')
		{
			load_data(search);
...
$(document).ready(function(){
	...
	{
		$.ajax({
			url:"<?php echo base_url('kasir/ajaxsearch/plntoken'); ?>",
			method:"POST",
			data:{query:query},
			success:function(data){
				$('#result').html(data);
