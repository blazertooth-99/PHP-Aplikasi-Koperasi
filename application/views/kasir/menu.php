        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="kasir/home" class="navbar-brand"><b>KPRI SEHAT</b></a>
                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown <?php if($title == 'Data Pembayaran'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="kasir/transaksi/baru">Konfirmasi Pembayaran</a></li>
                                <li class="divider"></li>
                                <li><a href="kasir/transaksi/saldo">Pembayaran Simpanan</a></li>
                            </ul>
                        </li>
                        <li class="dropdown <?php if($title == 'Data Transaksi'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="kasir/transaksi">Transaksi Simpanan</a></li>
                                <li class="divider"></li>
                                <li><a href="kasir/pengambilan">Pengambilan Sukarela</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="dropdown <?php if($title == 'Data Penjualan'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="kasir/home">Penjualan Kasir</a></li>
                                <li class="divider"></li>
                                <li><a href="kasir/penjualan/riwayat">Riwayat Transaksi</a></li>
                            </ul>
                        </li>
                        <li class="dropdown <?php if($title == 'PPOB'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="kasir/ppob">Menu PPOB</a></li>
                                <li class="divider"></li>
                                <li><a href="kasir/ppob/riwayat">Riwayat Transaksi PPOB</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
