        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="user-block">
                    <div class="row">
                        <div class="col-lg-6">
                            <img src="img/icon/icon_train_02.png" class="img-circle" alt="Icon Kereta" style="box-shadow: 0 0 5px #2727273d;">
                            <span class="username">
                                <a><b>Surabaya Pasar Turi → Bandung</b></a>
                            </span>
                            <span class="description">Min, 10 Jan 2021 | 1 Dewasa</span>
                        </div>
                        <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="box box-success box-train">
                            ...
                            <div class="box-footer"></div>
                            <div class="box-header with-border">
                                <h3 class="box-title"><b><i class="fa fa-train"></i> Nama Kereta</b></h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="box box-success box-train">
                            <div class="box-header with-border">
                                <h3 class="box-title"><b>Jayabaya 113</b> <span>Ekonomi (S)</span></h3>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-lg-5">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 hidden-xs">
                                                <img src="img/icon/jurusan_kai.png" alt="" width="90" style="margin-top: 25px; margin-left:-65px;">
                                            </div>
                                            <div class="col-lg-5">
                                                <h4><b>03:45</b></h4>
                                                <p>Pasar Senen  <br> (PSE)</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-2">
                                        <center><h4>3j 2m</h4></center>
                                    </div>
                                    <div class="col-lg-3">
                                        <center><h4>Rp115.000/orang</h4></center>
                                    </div>
                                    <div class="col-lg-2">
                                        <a href="#" class="pull-right btn btn-block btn-success">Pilih</a><br><br>
