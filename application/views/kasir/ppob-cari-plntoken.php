                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h2 class="page-header">
                                            <i class="fa fa-globe"></i> <b>KPRI SEHAT</b>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="7"></td>
                                                <td>
                                                    <a href="<?= base_url() ?>kasir/ppob/pln/token/<?= $id_pel.'/'.$denom ?>" class="btn btn-warning btn-block pull-right"><i class="fa fa-arrow-circle-right"></i> Lanjutkan Transaki</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
