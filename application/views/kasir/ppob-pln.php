                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tagihan">
                                            <form action="kasir/ppob/aksi/plnpasca" method="post">
                                                <div class="form-group">
                                                    <label for="">No. Meter/ID Pel <i class="fa fa-info-circle"></i></label>                                        
                                                    <div class="input-group">
                                                        <input type="text" name="no_telepon" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="No. Meter/ID Pel" required>

                                                        <div class="input-group-addon">
                                                            <img src="img/icon/icon_pln.png" alt="" height="20">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
