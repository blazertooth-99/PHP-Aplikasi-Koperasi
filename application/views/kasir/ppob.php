            ...
            <div class="col-lg-10">
                <div class="box box-success">
                    <div class="box-header with-border">
                        ...
                        <h2 class="box-title"><b><i class="fa fa-mobile-phone"></i> Beli Pulsa</b></h2>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <form action="<?= base_url() ?>kasir/ppob/aksi/pulsa" autocomplete="off" role="presentation" method="post">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Nomor Telepon <i class="fa fa-info-circle"></i></label>                                        
                                        <input name="phone" type="text" placeholder="Nomor HP" id="search_text" class="form-control notelp" minlength="10" maxlength="14" onkeypress="return isNumberKey(event)" >
                                    </div><hr>
                                    <div class="form-group">
