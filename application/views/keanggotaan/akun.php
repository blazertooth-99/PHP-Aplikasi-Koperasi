    ...
    <section class="content">    
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                <h2 class="box-title"><b><i class="fa fa-edit"></i> Edit Data Akun KPRI SEHAT DKK</b></h2>
            </div>
            <div class="box-body">
                <?php foreach($akun as $a) : ?>
                <form action="<?= base_url('keanggotaan/akun/edit') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6">
