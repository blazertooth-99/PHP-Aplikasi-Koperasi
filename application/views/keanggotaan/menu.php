        ...
        <nav class="navbar navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    <a href="keanggotaan/home" class="navbar-brand"><b>KPRI SEHAT DKK</b></a>
                ...
                <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown <?php if($title == 'Data Transaksi' || $title == 'Verifiikasi Transaksi'){ echo 'active'; } ?>">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="keanggotaan/saldo">Potong Saldo</a></li>
                                <li class="divider"></li>
