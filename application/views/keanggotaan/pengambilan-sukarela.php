        ...
        <div class="row">
            ...
            <div class="col-md-12">                
                <div class="box">
                    ...
                    <div class="box-body">
                        <form action="keanggotaan/pengambilan/aksi_pengambilan" target="_blank" method="post">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <a href="keanggotaan/home" class="btn btn-danger"><i class="fa fa-reply"></i> Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </form>
