                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nominal_shu" class="form-control" placeholder="Nominal SHU" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">                                    
