        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs ">
                    <li class="active"><a href="#sukarela" data-toggle="tab">Saldo Anggota</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="pokok">
                        <h4 class="box-title"><b><i class="fa fa-money"></i> Saldo Anggota</b></h4><hr>
                        <div class="row">
