    ...
    <section class="content">    
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                ...
                <h2 class="box-title"><b><i class="fa fa-plus-square"></i> Tambah Data Pengguna KPRI SEHAT DKK</b></h2>
            </div>
            <div class="box-body">
            <form action="keanggotaan/pengguna/aksi_tambah" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="level" class="form-control" required>
                                    <option value="1">Admin KOPRANESIA</option>
                                    <option value="2" selected>Kasir KOPRANESIA</option>
