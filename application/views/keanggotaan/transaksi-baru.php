...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            Top Up Saldo Anggota<small> KPRI SEHAT DKK</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-money"></i> Top Up Saldo Anggota</a></li>
        </ol>
    </section>
            ...
            <div class="col-md-12">                
                <div class="box">
                    <div class="box-header with-border">
                        <h2 class="box-title"><b><i class="fa fa-money"></i> Top Up Saldo Anggota</b></h2>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_anggota" id="no_anggota" class="form-control" placeholder="No. Anggota ( Data No. Anggota ada di tabel data anggota)" required>
